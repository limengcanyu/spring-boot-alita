...
//    }
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/alita?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
...
//        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.spring.boot.mybatisplus");
...
//        strategy.setSuperEntityColumns("id");
        strategy.setInclude("platform_salary_item_definition");
